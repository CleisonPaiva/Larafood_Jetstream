...
class PlanProfileController extends Controller
{
    ...
    public function profiles($idPlan)
    {
        ...
        return view('admin.pages.plans.plans_profile.index', compact('plan', 'profiles'));
    }
    ...
    public function profilesAvailable(Request $request, $idPlan)
    {
        ...
        return view('admin.pages.plans.plans_profile.create', compact('plan', 'profiles', 'filters'));
    }
